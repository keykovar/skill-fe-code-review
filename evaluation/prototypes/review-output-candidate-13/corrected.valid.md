...
- [src/session.ts:9] token source: getSession() -> cachedToken; Disposition: [F-001]
- [src/runtime.ts:8] deployed owner: frozen source -> unavailable; Disposition: Cannot Verify
